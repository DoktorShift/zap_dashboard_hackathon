        ...
        <div class="p-3 sm:p-4 border-b border-orange-100/50 flex-shrink-0">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              ...
              <button
                @click="showMobileSidebar = false"
                class="touch-target p-2 text-gray-500 hover:bg-gray-100 rounded-lg transition-colors lg:hidden"
                title="Close sidebar"
              >
      ...
      <div class="flex-1 flex flex-col lg:ml-0">
        ...
        <div v-if="selectedConnection" class="p-3 sm:p-4 border-b border-orange-100/50 bg-white/50 backdrop-blur-sm flex-shrink-0">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3 flex-1 min-w-0">
              ...
              >
                <IconMenu2 class="w-4 h-4 sm:w-5 sm:h-5" />
              </button>
            ...
            <div class="flex items-center space-x-2 flex-shrink-0">
              <button
                ...
                class="touch-target p-2 text-gray-400 hover:text-gray-600 rounded-lg transition-colors"
        ...
        <div v-else class="flex-1 flex items-center justify-center p-4 sm:p-6">
          <div class="text-center text-gray-500 max-w-sm">
            ...
            <button
              @click="showMobileSidebar = true"
              class="touch-target mb-4 p-3 bg-orange-100 text-orange-600 rounded-lg lg:hidden"
              title="Show connections"
            >
              <IconMessageCircle class="w-6 h-6 mx-auto" />
            </button>
          ...
          <div class="bg-white rounded-xl p-4 sm:p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto shadow-2xl">
            <div class="flex items-center justify-between mb-4 sm:mb-6">
              ...
              <button
                ...
                class="touch-target text-gray-400 hover:text-gray-600 p-1 rounded-lg transition-colors"
                title="Close"
              >
                <IconX class="w-5 h-5" />
              </button>
