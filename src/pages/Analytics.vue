  ...
  <div>
    <div class="flex items-center">
      <p class="font-medium text-gray-900 truncate">
        {{ topSupporters[0].profile?.name || topSupporters[0].pubkey.substring(0, 8) + '...' }}
      </p>
      <a 
    ...
    <p class="text-sm font-bold text-orange-600">
      {{ topSupporters[0].totalAmount.toLocaleString() }} sats ({{ topSupporters[0].zapCount }})
    </p>
    <p v-if="topSupporters[0].profile?.lud16" class="text-xs text-blue-600 flex items-center">
